...
//Parses the data in from the form
	err := r.ParseForm()
	if err != nil {
...
//"smtp.gmail.com:587" accesses the gmail server
	Senderr := smtp.SendMail("smtp.gmail.com:587", smtp.PlainAuth("", from, password, "smtp.gmail.com"), from, []string{to}, []byte(msg))
	if Senderr != nil {
		log.Printf("Error: %s", Senderr)
		return
	}
